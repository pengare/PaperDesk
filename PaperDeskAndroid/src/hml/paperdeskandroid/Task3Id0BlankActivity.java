...
public class Task3Id0BlankActivity extends Activity {
	...
	public class MyReceiver extends BroadcastReceiver
	{
		...
		public void onReceive(Context context, Intent intent)
		{
			...
			if(command.startsWith("tap#0:2")) //0 tap 1 to pick one book
			{
				...
				intentEmailList.setClass(Task3Id0BlankActivity.this, Task3Id0EmailListActivity.class);
				startActivity(intentEmailList);
				
				Task3Id0BlankActivity.this.finish();			
			}
			else if(command.startsWith("taskChooser"))
			{
				Intent intentTaskChooser = new Intent();
				intentTaskChooser.setClass(Task3Id0BlankActivity.this, TaskChooserActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task3_id0_blank);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_task3_id0_blank, menu);
        return true;
    }
}
